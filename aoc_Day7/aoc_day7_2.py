def try_sign(goal, acc, numbers, index):
    ...
    with_merge_operator = try_sign(goal, int(str(acc) + str(numbers[index])), numbers, index+1)
    ...
    return with_multiply_operator or with_plus_operator or with_merge_operator
